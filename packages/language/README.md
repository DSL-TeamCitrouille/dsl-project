...
- [src/dam-dam.langium](src/dam-dam.langium) -  The grammar definition of your language
- [src/dam-dam-module.ts](src/dam-dam-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/dam-dam-validator.ts](src/dam-dam-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/dam-dam.monarch.ts](src/syntaxes/dam-dam.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/dam-dam.tmLanguage.json](syntaxes/dam-dam.tmLanguage.json) - Textmate based syntax highlighting instructions.
