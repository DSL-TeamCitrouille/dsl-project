...
- [src/damedame.langium](src/damedame.langium) -  The grammar definition of your language
- [src/damedame-module.ts](src/damedame-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/damedame-validator.ts](src/damedame-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/damedame.monarch.ts](src/syntaxes/damedame.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/damedame.tmLanguage.json](syntaxes/damedame.tmLanguage.json) - Textmate based syntax highlighting instructions.
